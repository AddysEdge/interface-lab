...
export default function ElementsList ({ data, title, description }) {
	...
	return (
		<div className='section pt-6 relative 2xl:static'>
			<div className='absolute h-1/2 max-h-60 2xl:max-h-84 dark:invert opacity-30 -z-20 pointer-events-none bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]'></div>
