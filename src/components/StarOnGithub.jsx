...
export default function StarOnGitHub () {
	...
	return (
		...
		// className='rounded-full  text-sm active:scale-95 px-4 py-0.5 bg-gradient-to-r from-indigo-600 via-purple-500 to-blue-600  border-white/10 border group drop-shadow-sm flex gap-1 items-center text-white w-fit group grow-x origin-left'
		>
